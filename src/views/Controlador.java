...
public class Controlador {
    ...
    public static ArrayList<AnimalViewModel> getAnimales(){
     ...
     public static ArrayList<EspecieViewModel> getEspeciesCmb(){
      ...
      public static ArrayList<PaisViewModel> getPaisesCmb(){
          ArrayList<PaisViewModel> paises = new ArrayList<>();
          for (Pais pais: Persistencia.getPaises()){
              paises.add(new PaisViewModel(pais));
          }
          return paises;
      }
    ...
    public static ComidaViewModel  calcularComida(){
     ...
     public static void crearCarnivoro(EspecieViewModel especieSelec, int edadSelec, PaisViewModel paisSelec, double pesoSelec, SectorViewModel sectorSelec) throws InvalidPropertiesFormatException {
     ...
     Pais pais = new Pais(paisSelec.getNombre(),paisSelec.getCodigoIso());
     
     Carnivoro carnivoro = new Carnivoro(edadSelec,pesoSelec,especie,sector,pais);
    ...
    public static void crearHerbivoro(EspecieViewModel especieSelec, int edadSelec, PaisViewModel paisSelec, double pesoSelec, SectorViewModel sectorSelec, double valorHerbivoroSelec) throws InvalidPropertiesFormatException {
     Especie especie = new Especie(especieSelec.getNombre(),especieSelec.getTipoAlimentacion(),especieSelec.getPorcentajePesoCarnivoro()); 
     Sector sector = buscarSector(sectorSelec.getNumero());
     Pais pais = new Pais(paisSelec.getNombre(),paisSelec.getCodigoIso());
     
     Herbivoro herbivoro = new Herbivoro(edadSelec,pesoSelec,especie,sector,valorHerbivoroSelec,pais);
